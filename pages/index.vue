  ...
  <div class="home">
    ...
    <!---Search--->
        ...
        <div class="container search">
          ...
          <button @click="clearSearch"  v-show="searchInput!== ''"  class="button">Clear</button>
        </div>
...
export default {
  ...
  async fetch(){
    ...
    methods:{
      ...
      async searchMovies(){
         const data = axios.get(`https://api.themoviedb.org/3/search/movie?api_key=65be719d58e8676f0076de6e148460c0&language=en-US&page=1&query=${this.searchInput}`)
          const result = await data
        result.data.results.forEach((movie) => {
